...
const PengolahanNilaiPageDetail = () => {
    ...
    const InputMenu = (e) => {
        return (
            <>
                <div>
                    <div className="text-4xl font-semibold mb-3">{e.title}</div>
                    <div className="flex">
                        <div className="w-60 mr-10">
                            <div className="text-2xl font-semibold mb-1">Pengetahuan</div>
                            <div className="text-lg mb-2">Nilai</div>
                            <input
                        ...
                        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <div className="w-full text-sm text-left">
                                <div className="ml-10 my-10">
                                    <InputMenu title="Penilaian Harian 1" />
                                    <InputMenu title="Penilaian Harian 2" />
                                    <InputMenu title="Penilaian Harian 3" />
                                    <InputMenu title="Penilaian Harian 4" />
                                    <InputMenu title="Penilaian Harian 5" />
                                    <InputMenu title="Penilaian Harian 6" />
                                    <InputMenu title="Penilaian Tengah Semester Ganjil" />
                                    <InputMenu title="Penilaian Tengah Semester Genap" />
                                    <InputMenu title="Penilaian Akhir Semester Ganjil" />
                                    <InputMenu title="Penilaian Akhir Semester Genap" />
...
PengolahanNilaiPageDetail.getLayout = Layout;
export default PengolahanNilaiPageDetail